    ...
    useEffect(() => {
        const handleBackPress = () => {
            if (pathname === "/Auth/SignUp") {
                // If currently on the Signup page
    ...
    return (
        <ThemeProvider>
            ...
            >
                {/* Screens */}
                <Stack.Screen
                    name="Gettingstart/GettingstartScreen"
                    options={{ title: "Gettingstart" }}
                />
                <Stack.Screen name="Home/Home" options={{ title: "Home" }} />
                <Stack.Screen
                    name="Components/EPDS/Questionnaire"
                    options={{ title: "EPDSQuestionnaire" }}
                />
                <Stack.Screen
                    name="Components/GDS/Questionnaire"
                    options={{ title: "GDSQuestionnaire" }}
                />
                <Stack.Screen
                    name="Components/DAS/Questionnaire"
                    options={{ title: "DASQuestionnaire" }}
                />
                ...
                <Stack.Screen
                    ...
                    options={{ title: "ForgotPasswordPage" }}
                />
                <Stack.Screen
                    name="OnboardingScreen/Onboarding"
                    options={{ title: "OnboardingPage" }}
                />
                ...
                {/* Child Component */}
                <Stack.Screen
                    name="Components/Child/Questionnaire"
                    options={{ title: "ChildQuestionnaire" }}
                />
            </Stack>
        </ThemeProvider>
    );
