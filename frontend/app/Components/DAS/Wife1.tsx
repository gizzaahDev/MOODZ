...
const Wife1 = ({ navigation }: { navigation: any }) => {
          ...
          <View style={styles.buttonContainer}>
            <TouchableOpacity  onPressIn={animateButton}>
              <Animated.View style={[styles.buttonWrapper, { 
                ...
                <Text style={styles.buttonText1}>"You are enough, just as you are.{'\n'} Embrace your strength and beauty every day."</Text>
              </Animated.View>
            </TouchableOpacity>
            ...
            <TouchableOpacity  onPressIn={animateButton}>
              <Animated.View style={[styles.buttonWrapper, { 
                ...
                <Text style={styles.buttonText1}>"A strong woman knows she is capable of anything,{'\n'} but a wise woman knows she doesn't have to do it all alone."</Text>
              </Animated.View>
            </TouchableOpacity>
            ...
            <TouchableOpacity  onPressIn={animateButton}>
              <Animated.View style={[styles.buttonWrapper, { 
                ...
                <Text style={styles.buttonText1}>"Your worth is not defined by what you do for others{'\n'} but by who you are at your core."</Text>
              </Animated.View>
            </TouchableOpacity>
            ...
            <TouchableOpacity  onPressIn={animateButton}>
              <Animated.View style={[styles.buttonWrapper, { 
                ...
                <Text style={styles.buttonText1}>"Take time to nurture yourself;{'\n'} you can't pour from an empty cup."</Text>
              </Animated.View>
            </TouchableOpacity>
            ...
            <TouchableOpacity  onPressIn={animateButton}>
              <Animated.View style={[styles.buttonWrapper, { 
                ...
                <Text style={styles.buttonText1}>"You are a masterpiece in progress,{'\n'} and every step forward is a victory."</Text>
              </Animated.View>
            </TouchableOpacity>
            ...
            <TouchableOpacity  onPressIn={animateButton}>
              <Animated.View style={[styles.buttonWrapper, { 
                ...
                <Text style={styles.buttonText1}>"Believe in yourself,{'\n'} and you will be unstoppable."</Text>
              </Animated.View>
            </TouchableOpacity>
            ...
            <TouchableOpacity  onPressIn={animateButton}>
              <Animated.View style={[styles.buttonWrapper, { 
                ...
                <Text style={styles.buttonText1}>"Self-love is the foundation of all love.{'\n'} Start with yourself."</Text>
              </Animated.View>
            </TouchableOpacity>
          </View>
