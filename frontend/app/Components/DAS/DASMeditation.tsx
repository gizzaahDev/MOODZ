      ...
      <View style={[styles.startcontainer, { backgroundColor: '#9DC183' }]}>
        ...
        <ScrollView style={styles.scrollView1}>
          <View style={styles.buttonContainer}>
            <TouchableOpacity onPress={handleMindPress} onPressIn={animateButton}>
              <Animated.View style={[styles.buttonWrapper, { transform: [{ scale: buttonScale }] }]}>
                <Text style={styles.buttonText1}>Mindfullness{'\n'}Meditation</Text>
              </Animated.View>
            </TouchableOpacity>

            <TouchableOpacity onPress={handleKindPress} onPressIn={animateButton}>
              <Animated.View style={[styles.buttonWrapper, { transform: [{ scale: buttonScale }] }]}>
                <Text style={styles.buttonText1}>Loving-Kindness{'\n'}Meditation</Text>
              </Animated.View>
            </TouchableOpacity>
