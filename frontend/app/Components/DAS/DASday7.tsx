...
const DASday7 = ({ navigation }: { navigation: any }) => {
    ...
    <FontLoader>
      <View style={[styles.container, { backgroundColor: theme.background }]}>
        <View style={styles.contentContainer}>
          <View style={styles.textContainer}>
            ...
            <Text style={[styles.textParagraph, { color: theme.textSecondary }]}>
              Try our Best YOGA Practices
            </Text>
            <Text style={[styles.textParagraph, { color: theme.textSecondary }]}>
              Enhance your FLEXIBILITY, BALANCE & ENERGY
            </Text>
          </View>
        ...
        <View style={styles.imageContainer}>
          <Image
            source={require('../../../assets/images/EPDSwel04.png')}
