      ...
      <View style={[styles.startcontainer, { backgroundColor: '#9DC183' }]}>
        ...
        <ScrollView style={styles.scrollView1}>
          <View style={styles.buttonContainer}>
            ...
            <TouchableOpacity onPress={handleSelfPress} onPressIn={animateButton}>
              <Animated.View style={[styles.buttonWrapper, { transform: [{ scale: buttonScale }] }]}>
                <Text style={styles.buttonText1}>Self-Love &{'\n'}Empowerment</Text>
              </Animated.View>
            </TouchableOpacity>

            <TouchableOpacity onPress={handleMarryPress} onPressIn={animateButton}>
              <Animated.View style={[styles.buttonWrapper, { transform: [{ scale: buttonScale }] }]}>
                <Text style={styles.buttonText1}>Marriage &{'\n'}Partnership</Text>
              </Animated.View>
            </TouchableOpacity>

            <TouchableOpacity onPress={handleStrengthPress} onPressIn={animateButton}>
              <Animated.View style={[styles.buttonWrapper, { transform: [{ scale: buttonScale }] }]}>
                <Text style={styles.buttonText1}>Strenght &{'\n'}Resillience</Text>
              </Animated.View>
            </TouchableOpacity>
          </View>
