...
// Save the image to DAScam/images directory
const imagePath = `${FileSystem.documentDirectory}DAScam/images/${Date.now()}.jpg`;
await FileSystem.makeDirectoryAsync(`${FileSystem.documentDirectory}DAScam/images`, { intermediates: true });
    ...
    <View style={styles.container}>
      ...
      >
        <View style={styles.controls}>
          ...
          <TouchableOpacity onPress={handleBackCam} style={styles.captureButton}>
