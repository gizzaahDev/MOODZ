...
const Husband3 = ({ navigation }: { navigation: any }) => {
  ...
  return (
    <FontLoader>
      <View style={[styles.startcontainer, { backgroundColor: '#FAF3F4' }]}>
          ...
          <View style={styles.buttonContainer}>
            <TouchableOpacity  onPressIn={animateButton}>
              <Animated.View style={[styles.buttonWrapper, { 
                ...
                <Text style={styles.buttonText1}>"A man's strength is not in never falling{'\n'} but in rising every time he falls."</Text>
              </Animated.View>
            </TouchableOpacity>
            ...
            <TouchableOpacity  onPressIn={animateButton}>
              <Animated.View style={[styles.buttonWrapper, { 
                ...
                <Text style={styles.buttonText1}>"Every challenge you face is an opportunity{'\n'} to grow stronger and wiser."</Text>
              </Animated.View>
            </TouchableOpacity>
            ...
            <TouchableOpacity  onPressIn={animateButton}>
              <Animated.View style={[styles.buttonWrapper, { 
                ...
                <Text style={styles.buttonText1}>"A resilient husband doesn't give up;{'\n'} he finds a way to keep going."</Text>
              </Animated.View>
            </TouchableOpacity>
            ...
            <TouchableOpacity  onPressIn={animateButton}>
              <Animated.View style={[styles.buttonWrapper, { 
                ...
                <Text style={styles.buttonText1}>"The best way to lead your family is{'\n'} to grow and improve yourself every day."</Text>
              </Animated.View>
            </TouchableOpacity>
            ...
            <TouchableOpacity  onPressIn={animateButton}>
              <Animated.View style={[styles.buttonWrapper, { 
                ...
                <Text style={styles.buttonText1}>"Strength is not about being unbreakable;{'\n'} it's about getting back up after you've been broken."</Text>
              </Animated.View>
            </TouchableOpacity>
            ...
            <TouchableOpacity  onPressIn={animateButton}>
              <Animated.View style={[styles.buttonWrapper, { 
                ...
                <Text style={styles.buttonText1}>"A man's greatest power is his ability{'\n'} to adapt, learn, and grow."</Text>
              </Animated.View>
            </TouchableOpacity>
            ...
            <TouchableOpacity  onPressIn={animateButton}>
              <Animated.View style={[styles.buttonWrapper, { 
                ...
                <Text style={styles.buttonText1}>"You are the rock of your family;{'\n'} stay strong, but don't forget to lean on others when you need to."</Text>
              </Animated.View>
            </TouchableOpacity>
          </View>
