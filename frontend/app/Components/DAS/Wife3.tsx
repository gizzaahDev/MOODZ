...
const Wife3 = ({ navigation }: { navigation: any }) => {
          ...
          <View style={styles.buttonContainer}>
            <TouchableOpacity  onPressIn={animateButton}>
              <Animated.View style={[styles.buttonWrapper, { 
                ...
                <Text style={styles.buttonText1}>"You are stronger than you think,{'\n'} braver than you believe, and more capable than you imagine."</Text>
              </Animated.View>
            </TouchableOpacity>
            ...
            <TouchableOpacity  onPressIn={animateButton}>
              <Animated.View style={[styles.buttonWrapper, { 
                ...
                <Text style={styles.buttonText1}>"Life may knock you down,{'\n'} but you have the power to rise again and again."</Text>
              </Animated.View>
            </TouchableOpacity>
            ...
            <TouchableOpacity  onPressIn={animateButton}>
              <Animated.View style={[styles.buttonWrapper, { 
                ...
                <Text style={styles.buttonText1}>"A resilient woman doesn't avoid challenges;{'\n'} she faces them head-on with courage."</Text>
              </Animated.View>
            </TouchableOpacity>
            ...
            <TouchableOpacity  onPressIn={animateButton}>
              <Animated.View style={[styles.buttonWrapper, { 
                ...
                <Text style={styles.buttonText1}>"Every storm you weather makes you{'\n'} stronger and more unshakable."</Text>
              </Animated.View>
            </TouchableOpacity>
            ...
            <TouchableOpacity  onPressIn={animateButton}>
              <Animated.View style={[styles.buttonWrapper, { 
                ...
                <Text style={styles.buttonText1}>"You are not defined by your struggles{'\n'} but by how you overcome them."</Text>
              </Animated.View>
            </TouchableOpacity>
            ...
            <TouchableOpacity  onPressIn={animateButton}>
              <Animated.View style={[styles.buttonWrapper, { 
                ...
                <Text style={styles.buttonText1}>"Strength doesn’t come from what you can do;{'\n'} it comes from overcoming what you thought you couldn’t."</Text>
              </Animated.View>
            </TouchableOpacity>
            ...
            <TouchableOpacity  onPressIn={animateButton}>
              <Animated.View style={[styles.buttonWrapper, { 
                ...
                <Text style={styles.buttonText1}>"You are a warrior, and every battle you face{'\n'} makes you wiser and more powerful."</Text>
              </Animated.View>
            </TouchableOpacity>
          </View>
