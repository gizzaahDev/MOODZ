...
const MeditationActivity = () => {
    ...
    const videoUri = 'https://firebasestorage.googleapis.com/v0/b/testdb-8ea15.firebasestorage.app/o/MOODZ%2FVideo%2FGuided%20Box%20Breathing%20with%20Theta-Waves%20To%20Wind-Down.mp4.mp4?alt=media&token=538c690e-2670-46eb-9ffe-b93745379f10';
    ...
    const handleDone = async () => {
        try {
            ...
            const data = userDoc.data() || { meditationHistoryBreathing: {}, hearts: 0, leaves: 0, activityType: {}, completedActivities: [] };
            ...
            const todayHistory = data.meditationHistoryBreathing?.[today] || {};

            // Create the completed activity object
            ...
            await userRef.set(
                {
                    ...
                    meditationHistoryBreathing: {
                        ...data.meditationHistoryBreathing,
                        [today]: {
                    ...
                    completedActivities: [...(data.completedActivities || []), completedActivity], // Add completed activity to the array
                },
                { merge: true }
            );
