// frontend/app/Components/EPDS/SubComponents/ActivityPages/Activity12/Id12.tsx
import React, { useState, useEffect } from 'react';
import { View, Text, StyleSheet, TouchableOpacity, ScrollView, Modal, FlatList, Image } from 'react-native'; // Import Image
...
const MeditationHome = () => {
    ...
    const [capturedImageUri, setCapturedImageUri] = useState<string | null>(null); // State for captured image URI
    ...
    useEffect(() => {
        ...
        loadImageUri(); // Load the image URI when the component mounts
    }, [userId]);
    ...
    const loadImageUri = async () => {
        try {
            const imageUri = await AsyncStorage.getItem('capturedImageUri');
            if (imageUri) {
    ...
    return (
        <View style={[styles.container, { backgroundColor: theme.background }]}>
            <View style={[styles.subMiniContainer]}>
                <Text style={[styles.title, { color: theme.textPrimary }]}>Capture Your Mood</Text>
                <Text style={[styles.guidelines, { color: theme.textSecondary }]}>
                    Notice your mood. Focus on deep breathing and presence. This meditation helps you understand your feelings.
                </Text>
                <ScrollView>
                ...
                <View style={styles.buttonContainer}>
                    <TouchableOpacity
                        style={styles.button}
                        onPress={() => router.push('/Components/EPDS/SubComponents/ActivityPages/Activity12/GratitudeList')}>
